...
Hi! I'm **Simonel-Olimpiu David**, a **Mid DevOps Engineer at COERA BC SRL** and **EO Platform Product Manager at AIM-SPACE**. I'm passionate about **software infrastructure** and **space technology**, always eager to explore and innovate on challenges that push my technical and leadership skills. Currently pursuing a **Master's in Distributed Systems in Internet** at Babeș-Bolyai University.
...
Designing and operating AWS and Kubernetes infrastructure with CI/CD automation and infrastructure-as-code.

### **Advanced Junior DevOps Engineer @ COERA BC SRL** *(Jul 2025 – Jan 2026)*
Improved cloud reliability through Terraform-based automation and production monitoring.

### **Junior DevOps Engineer @ COERA BC SRL** *(Jun 2024 – Jul 2025)*
Built Kubernetes platforms and centralized monitoring to improve deployment efficiency.

### **Trainee DevOps Engineer @ COERA BC SRL** *(Oct 2022 – Jun 2024)*
Supported cloud automation and CI/CD using Terraform, Ansible, and Jenkins.

### **DevOps Intern @ COERA BC SRL** *(Jul 2022 – Aug 2022)*
Introduced to cloud and DevOps practices through Azure-based deployments.

### **EO Platform Product Manager @ AIM-SPACE** *(Nov 2025 – Present)*
Leading an Earth Observation platform by aligning satellite data capabilities with product strategy.

### **Software Engineer @ AIM-SPACE** *(Mar 2023 – Nov 2025)*
Developed satellite data processing and geospatial analysis solutions.
...
- **ROSPIN School Project Manager** *(Jan 2022 – Sep 2022)* — Led inaugural edition with 300 students on space science and technology.
...
Machine Learning · Cybersecurity · Space Exploration · Satellites · Astronomy · Video Games · Open-Source Projects · Music · Violin · Guitar · Contemporary Dances

---

## 🚀 Featured Projects

### [Autonomous Heat Island Detection Tool](https://github.com/SimonelDavid/HeatIslands)
...
- A ROSPIN workshop on the advantages and disadvantages of Copernicus and Landsat satellite data.
...
- A ROSPIN workshop on deploying a simple web application that processes satellite data.
- **Technologies:** Docker, Shell Scripting, Python, GEE, Copernicus Hub.

### [SpacedIn Platform](https://spacedin.getlearnworlds.com/)
- A platform to educate students on space engineering and the lifecycle of space missions.

### [ROSPIN Website](https://rospin.org/)
- Developed the main website of ROSPIN.

### [WhatsApp Automation Tool](https://github.com/SimonelDavid/WhatsAppMessageAutomation)
- Automation tool to support ROSPIN staff across projects.
- **Technologies:** Python.
...
[![Email](https://img.shields.io/badge/-Email-EA4335?logo=gmail&logoColor=white&style=flat-square)](mailto:simoneldavid17@gmail.com)
